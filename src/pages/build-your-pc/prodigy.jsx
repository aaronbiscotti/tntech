...
export default function prodigy({ products }) {
    ...
    return (
        <>
            <div>
                ...
                <div className="bg-prodigybg bg-cover bg-no-repeat bg-top">
                    ...
                    <main>
                        ...
                        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-8 relative">
                            ...
                            <section aria-labelledby="products-heading">
                                ...
                                <div className="grid grid-cols-1 gap-y-10 sm:grid-cols-2 gap-x-6 lg:grid-cols-3 xl:gap-x-8 pb-32">
