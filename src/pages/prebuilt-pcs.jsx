                            ...
                            <div className="py-20 text-center mb-10 bg-cover bg-no-repeat bg-top">
                                <div>
                                    ...
                                    <p className="mt-4 max-w-3xl mx-auto text-base">
                                        The complete collection of our best industry machines, designed by us and created for you.
                                    </p>
                                </div>
                            </div>
                                    ...
                                    {products.edges.map((item) => {
                                        ...
                                        return (
                                            <div>
                                                ...
                                                <div className="flex mt-1 space-x-1">{previewImages.map((item, i) => {
                                                    const image = item.node
                                                    return (
                                                        <img src={image.transformedSrc} key={i} className={`object-cover rounded w-14 h-12 duration-200 ease-in-out ${image === featuredImage ? 'opacity-100' : 'opacity-75'}`} onClick={() => {
